...
public class Board extends JPanel implements Runnable, Constants {
	...
	public Board(int width, int height) {
		...
		playerName = (String) JOptionPane.showInputDialog(null, "Please enter your name:", "Brick Breaker, Version 1.1.1", JOptionPane.QUESTION_MESSAGE);
		if (playerName == null) {
			System.exit(0);
		}
		if (((java.lang.String) playerName).toUpperCase().equals("NIRU") || ((java.lang.String) playerName).toUpperCase().equals("NIRANJAN") || playerName.toUpperCase().equals("PRASAD")) {
			score += 1000;
